...
import com.regnosys.rosetta.generator.haskell.enums.HaskellEnumGenerator;
import com.regnosys.rosetta.generator.haskell.functions.HaskellFunctionGenerator;
import com.regnosys.rosetta.generator.haskell.object.HaskellModelObjectGenerator;
...
public class HaskellCodeGenerator extends AbstractExternalGenerator {

	@Inject
	HaskellModelObjectGenerator pojoGenerator;
	@Inject
	private HaskellEnumGenerator enumGenerator;
	@Inject
	private HaskellFunctionGenerator functionGenerator;

	public HaskellCodeGenerator() {
		super("Haskell");
		enumGenerator = new HaskellEnumGenerator();
	}
